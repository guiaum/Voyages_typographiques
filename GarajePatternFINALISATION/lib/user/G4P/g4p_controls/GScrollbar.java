...
class GScrollbar extends GAbstractControl {
	...
	private static final int OVER_FILL = 0;
	private static final int OVER_STROKE = 0;
	...
	public GScrollbar(PApplet theApplet, float p0, float p1, float p2, float p3) {
		...
		lowCap = new RoundRectangle2D.Float(1, 1, 15, height-2, 0, 0);
		highCap = new RoundRectangle2D.Float(width - 15, 1, 14.5f, height-2, 0, 0);
	...
	protected void updateBuffer(){
		if(bufferInvalid) {
			...
			RoundRectangle2D thumb = new RoundRectangle2D.Float(1,1,thumbWidth-1, height-2,0,0);
